...
O código foi mantido apenas para referência histórica.
...
class CodeSandbox:
    ...
    def _is_dangerous(self, code: str) -> bool:
        dangerous = ['import os', 'import subprocess', 'import sys', '__import__', 'eval(', 'exec(', 'compile(', 'open(', 'file(']
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "language": {"type": "string", "description": "Linguagem (padrão: python)", "default": "python"}
            },
            "required": ["code"]
        }
    }
